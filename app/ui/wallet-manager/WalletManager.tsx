...
export function WalletManager({ memberId }: WalletManagerProps) {
  ...
  // Chain tag — token-based. EVM = ink-on-cream, Solana = butter accent.
  ...
  if (loading) {
    return (
      <div style={sectionStyle}>
        <h3 style={{ ...sectionTitle, marginBottom: 16 }}>Wallets</h3>
        <div
  ...
  return (
    <div style={sectionStyle}>
              ...
              {editingId !== w.id && (
                <div style={{ display: "flex", gap: 2, flexShrink: 0 }}>
                  ...
                  {confirmDeleteId === w.id ? (
                    ...
                    >
                      <span
                        style={{ fontSize: 11, color: "hsl(var(--tomato))" }}
                      >
                        Delete?
                      </span>
                      <button
        ...
        >
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            <select
              value={manualChain}
              onChange={(e) =>
                setManualChain(e.target.value as "evm" | "solana")
              }
              style={{
                ...inputStyle(),
                padding: "8px 12px",
          ...
          <button
            ...
            style={{
              ...btn("primary", !manualAddress.trim() || saving),
              alignSelf: "start",
              fontSize: 13,
            }}
          >
      ...
      {wallets.length === 0 && !showManualAdd && (
        ...
        >
          No wallets connected yet. Connect a wallet to display your NFT and
          POAP collections.
        </div>
      )}
    </div>
